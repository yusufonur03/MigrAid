...
import { FaSyncAlt, FaBuilding, FaMapSigns, FaIndustry, FaGraduationCap, FaHandsHelping, FaComments, FaGlobeEurope, FaWpforms, FaCalendarAlt, FaUserCog, FaBookOpen, FaHandHoldingHeart } from 'react-icons/fa';
import './Home.css';
    ...
    <>
      ...
      <div className="features-row" style={{ marginTop: '2rem' }}>
        <div className="feature-card">
          ...
          <Link to="/sohbet-asistani" className="feature-title-link">Sohbet Asistanı</Link>
          <div className="feature-desc">Yapay zekâ ile doğal dilde rehberlik (örnek: "oturma izni almak istiyorum")</div>
        </div>
        <div className="feature-card">
          <FaGlobeEurope className="feature-icon" style={{color: '#f472b6'}} />
          <Link to="/kulturel-rehber" className="feature-title-link">Kültürel Rehber</Link>
        ...
        <div className="feature-card">
          ...
          <Link to="/form-yardimi" className="feature-title-link">Form Doldurma Yardımı</Link>
          <div className="feature-desc">AI destekli başvuru formu oluşturucu</div>
        </div>
        <div className="feature-card">
          <FaCalendarAlt className="feature-icon" style={{color: '#60a5fa'}} />
          <Link to="/dijital-ajanda" className="feature-title-link">Dijital Ajanda</Link>
        ...
        <div className="feature-card">
          ...
          <Link to="/is-eslestirme" className="feature-title-link">Beceriye Göre İş Eşleştirme</Link>
        ...
        <div className="feature-card">
          ...
          <Link to="/egitim-dil-firsatlari" className="feature-title-link">Eğitim & Dil Fırsatları</Link>
        ...
        <div className="feature-card">
          ...
          <Link to="/yolharitasi" className="feature-title-link">Yol Haritası</Link>
      ...
      <div style={{width: '100%', background: '#eaf6ff', minHeight: '420px', margin: 0, padding: 0, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
        <div style={{display: 'flex', width: '100%', maxWidth: '1200px', gap: '2.5rem', justifyContent: 'center', alignItems: 'stretch', paddingTop: '2.5rem', paddingBottom: '2.5rem'}}>
          {/* Sıkça Sorulan Sorular */}
          <div style={{flex: 2, background: '#fff', borderRadius: '1.5rem', boxShadow: '0 2px 12px rgba(74,144,226,0.08)', padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
            <h2 style={{color: 'var(--primary-blue)', marginBottom: '1.2rem', fontWeight: 700, fontSize: '1.5rem'}}>Sıkça Sorulan Sorular</h2>
            ...
            <div>
              ...
              <div style={{color: '#444'}}>Ana sayfadaki hizmet kartlarından ihtiyacınıza uygun olanı seçebilirsiniz.</div>
            </div>
          </div>
          {/* Sağda slider için kutu */}
          <div style={{flex: 1, minWidth: '260px', maxWidth: '340px', background: '#fff', borderRadius: '1.5rem', boxShadow: '0 2px 12px rgba(74,144,226,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', position: 'relative'}}>
            <img 
              src={bottomSliderImages[bottomCurrent]} 
              alt="slider" 
              style={{width: '100%', height: '100%', objectFit: 'cover', borderRadius: '1.5rem', transition: 'opacity 0.7s', opacity: 0.93}} 
            />
          </div>
        </div>
      </div>
